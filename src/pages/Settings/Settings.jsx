                ...
                <div style={{ position: "relative", zIndex: 1 }}>
                  ...
                  <div style={{ display: "flex", justifyContent: "center", gap: "24px", marginBottom: "56px", flexWrap: "wrap" }}>
                    ...
                    >
                      ...
                      <div>
                        <div style={{ color: "#64748B", fontSize: "12px", fontWeight: 700, textTransform: "uppercase", letterSpacing: "1px" }}>Styling System</div>
                        <div style={{ color: "white", fontSize: "15px", fontWeight: 700, marginTop: "4px" }}>CSS / Tailwind</div>
                      </div>
                    </motion.div>
                  </div>
